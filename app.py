...
if "alert_id" in params and "action" in params:
    ...
    supabase.table("alert_log").update({
        ...
        "action_date": datetime.utcnow().isoformat()   # ✅ native Python timestamp
...
# ============================================================
# PAGE: PRODUCTS (pagination with lightweight count)
# ============================================================
elif page == "Products":
...
# ============================================================
# PAGE: CSV UPLOAD (with user guide and templates)
# ============================================================
...
# ============================================================
# PAGE: RISK & FEFO (database‑level sorting + pagination)
# ============================================================
elif page == "Risk & FEFO":
    ...
    **Risk Levels:** LOW 🟢 → MODERATE 🟡 → HIGH 🟠 → CRITICAL 🔴
    ...
    # Sort selection – moved before query to apply database‑level ordering
    ...
    # For FEFO, we still need to sort the current page's rows by expiry date (then risk score)
...
# ============================================================
    ...
    **Optimised suggestions** – computed entirely inside the database for speed and scalability.
    ...
    suggestions = query.execute().data
