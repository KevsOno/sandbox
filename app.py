...
# ============================================================
# PAGE: DASHBOARD (uses RPC aggregates)
# ============================================================
if page == "Dashboard":
...
# ============================================================
    ...
    # Lightweight count: head=True returns only count, no data
...
# ============================================================
# PAGE: INVENTORY (pagination with lightweight count)
# ============================================================
elif page == "Inventory":
...
# ============================================================
# PAGE: ALERTS & ADVISORIES (pagination with lightweight count)
# ============================================================
...
# ============================================================
# PAGE: AI LIMITS (pagination with lightweight count)
# ============================================================
elif page == "AI Limits":
...
# ============================================================
# PAGE: RISK & FEFO (reads precomputed product_risk_scores)
# ============================================================
elif page == "Risk & FEFO":
...
# ============================================================
# PAGE: TRANSFER SUGGESTIONS (optimised – database view)
# ============================================================
    ...
    **Optimised suggestions** – computed entirely inside the database for speed and scalability.
    ...
    # The view `view_transfer_suggestions` must exist in Supabase (run the provided SQL once)
